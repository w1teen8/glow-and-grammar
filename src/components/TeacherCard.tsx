...
export default function TeacherCard({
  ...
  return (
    <div className="relative h-full overflow-hidden rounded-xl2 border border-olive/10 bg-white/90 p-6 shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-premium sm:p-8">
