...
async function main() {
  ...
  const founderBio =
    "Мілєна — засновниця Glow & Grammar та Senior Methodologist з фокусом на учнях 8–18 років. Поєднує глибоку методологічну підготовку за стандартами Cambridge та Oxford із живою практикою в міжнародному англомовному середовищі, вибудовуючи для кожного учня персональну траєкторію до вільного, впевненого мовлення.";
